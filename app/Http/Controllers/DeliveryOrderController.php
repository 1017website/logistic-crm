...
class DeliveryOrderController extends Controller
{
    public function index(Request $request)
    {
        ...
        $sos = $query->orderByDesc('order_date')->orderByDesc('id')->paginate(15)->withQueryString();
        ...
        $vendorServices = \App\Models\\App\Models\VendorService::with('vendor')
            ->orderBy('service_name')->get(['id', 'vendor_id', 'service_name', 'unit', 'tariff', 'tariff_unit']);

        return view('delivery_orders.index', compact(
            'sos', 'revenue', 'grossProfit', 'volumeDo', 'totalCost',
            'customers', 'vendors', 'leads', 'vendorServices',
